export const siteContent = {
  schoolName: 'Glorious Group of Schools',
  ...
  whyChooseUs: [
    {
      ...
      description: 'Consistent top performance in national examinations with a focus on mastery of the CBC curriculum.',
      icon: 'GraduationCap',
    },
    {
      title: 'Qualified Teachers',
      description: 'Highly trained, experienced, and dedicated educators who inspire a love for learning.',
      icon: 'Users',
    },
    {
      title: 'Holistic Learning',
      description: 'Balanced development through academics, sports, arts, and character education.',
      icon: 'BookOpen',
    },
    {
      title: 'Safe Environment',
      description: 'Secure, well-maintained campus with modern facilities and round-the-clock supervision.',
      icon: 'Shield',
    },
    {
      title: 'Christian Values',
      description: 'Strong moral foundation rooted in Christian principles and ethical teaching.',
      icon: 'Heart',
    },
    {
      title: 'Technology Integration',
      description: 'Modern digital tools and resources integrated into everyday learning experiences.',
      icon: 'Monitor',
    },
    {
      title: 'Student-Centered Learning',
      description: 'Personalized attention with small class sizes and differentiated instruction.',
      icon: 'Star',
    },
  ],
  ...
  testimonials: [
    {
      name: 'Grace Wanjiku',
      role: 'Parent',
      content: 'Glorious Group of Schools has been a blessing to our family. My children have grown academically and morally since joining. The teachers truly care about each child\'s development.',
      rating: 5,
    },
    {
      name: 'Peter Kamau',
      role: 'Parent',
      content: 'The discipline and academic standards at this school are outstanding. My son\'s transformation in confidence and performance has been remarkable. I highly recommend this school.',
      rating: 5,
    },
    {
      name: 'Sarah Akinyi',
      role: 'Alumni',
      content: 'My years at Glorious Group of Schools laid the foundation for my success in university and beyond. The skills, values, and friendships I gained are invaluable.',
      rating: 5,
    },
    {
      name: 'David Mwangi',
      role: 'Parent',
      content: 'What sets this school apart is the genuine partnership between teachers and parents. Communication is excellent, and my child feels truly supported.',
      rating: 5,
    },
    {
      name: 'James Ochieng',
      role: 'Student',
      content: 'I love how the school encourages us to explore our talents. I discovered my passion for science through the STEM club. The teachers make learning fun!',
      rating: 5,
    },
    {
      name: 'Margaret Nyambura',
      role: 'Parent',
      content: 'The Christian values instilled in our children complement what we teach at home. Seeing my child pray before meals and show kindness to others fills me with joy.',
      rating: 5,
    },
  ],
  ...
  latestNews: [
    {
      title: 'Glorious Schools Shine in National Science Fair',
      excerpt: 'Our students brought home 8 gold medals at the National Science and Innovation Fair, showcasing outstanding projects in renewable energy and environmental conservation.',
      date: 'June 15, 2026',
      category: 'Achievements',
      image: 'science-fair',
    },
    {
      title: 'Annual Sports Day: A Celebration of Talent',
      excerpt: 'The 2026 Annual Sports Day was a resounding success with record-breaking performances, new trophies, and wonderful displays of sportsmanship from all houses.',
      date: 'May 28, 2026',
      category: 'Events',
      image: 'sports-day',
    },
    {
      title: 'Enrollment for 2027 Academic Year Now Open',
      excerpt: 'We are pleased to announce that enrollment for the 2027 academic year is now open. Early bird discounts available for registrations received before October 31st.',
      date: 'July 1, 2026',
      category: 'Announcements',
      image: 'enrollment',
    },
    {
      title: 'Music Festival: Celebrating Young Talent',
      excerpt: 'Our students delivered breathtaking performances at the Annual Music Festival, showcasing talents in choir, instrumental, and traditional dance categories.',
      date: 'April 10, 2026',
      category: 'Events',
  ...
  upcomingEvents: [
    { title: 'Parent-Teacher Conference', date: 'August 15, 2026', time: '8:00 AM - 3:00 PM' },
    { title: 'Inter-House Athletics Competition', date: 'September 5, 2026', time: '7:00 AM - 4:00 PM' },
    { title: 'Academic Awards Ceremony', date: 'September 20, 2026', time: '9:00 AM - 12:00 PM' },
    { title: 'Career Day', date: 'October 12, 2026', time: '9:00 AM - 2:00 PM' },
    { title: 'Graduation Ceremony', date: 'November 15, 2026', time: '8:00 AM - 1:00 PM' },
    { title: 'Christmas Carols Festival', date: 'December 5, 2026', time: '4:00 PM - 7:00 PM' },
  ],
  ...
  academics: {
    levels: [
      {
        name: 'Early Years (Pre-Primary)',
        ageRange: 'Ages 3 - 5',
        description: 'Our Early Years program provides a warm, stimulating environment where young learners develop foundational skills through play-based learning, sensory activities, and guided exploration. We focus on social-emotional development, early literacy, numeracy, and creative expression.',
        highlights: ['Play-based learning', 'Language development', 'Motor skills', 'Socialization', 'Creative arts', 'Biblical foundation'],
      },
      {
        name: 'Primary School (Grades 1 - 6)',
        ageRange: 'Ages 6 - 12',
        description: 'Our Primary program builds on foundational skills with a comprehensive CBC curriculum. Students develop critical thinking, problem-solving abilities, and a love for learning through engaging lessons, hands-on activities, and collaborative projects.',
        highlights: ['CBC curriculum', 'Integrated learning', 'Character education', 'Sports & arts', 'Technology', 'Community service'],
      },
      {
        name: 'Junior School (Grades 7 - 9)',
        ageRange: 'Ages 12 - 15',
        description: 'Junior School prepares students for the transition to senior secondary education with an enhanced academic program, leadership opportunities, career guidance, and mentorship. Students explore subjects in greater depth while developing independent learning skills.',
        highlights: ['Advanced CBC curriculum', 'Leadership development', 'Career guidance', 'STEM focus', 'Debate & public speaking', 'Community outreach'],
      },
    ],
